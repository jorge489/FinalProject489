...
class ClientApp(FlaskView):
    ...
    def _enabled_disable_system(self, enable):
        mqtt_topic = "FWH/2311/Micro850-7.ie.ncsu.edu/SystemCommand"
        dataObj={}
    ...
    def _queryDB(self):
        qCmd = """SELECT t.* FROM public.sensor_data2 t LIMIT 100 """
...
db_host = "postgresql://smartmanufacturing_example2_user:6uqQeH5gCEa9JO8jodTjSqSrTSgpZF2I@dpg-csl8rsqj1k6c739jt41g-a.ohio-postgres.render.com/smartmanufacturing_example2"
